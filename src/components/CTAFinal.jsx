...
function CTAFinal() {
    return (
        <section className="min-h-screen flex items-center py-32 md:py-48 px-6 md:px-12 lg:px-20 bg-cream">
            <div className="max-w-7xl mx-auto w-full">
                <div className="grid md:grid-cols-12 gap-16 items-center">
                    ...
                    >
                        <h2 className="text-[clamp(2.5rem,7vw,9rem)] font-serif text-deep-black leading-[0.95] mb-12">
                            Conversemos
                        </h2>

                        <motion.button
                            className="group bg-deep-black text-cream px-12 py-5 text-base tracking-widest uppercase font-medium relative overflow-hidden"
                    ...
                    >
                        ...
                        <div className="border-t-2 border-deep-black pt-6">
                            <p className="text-lg text-warm-gray italic">
